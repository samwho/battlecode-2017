...
public strictfp class RobotPlayer {
  ...
  public static void run(RobotController rc) throws GameActionException {
    ...
    // from this robot, and to get information on its current status.
    RobotPlayer.rc = rc;

    // Here, we've separated the controls into a different method for each
    // RobotType.  You can add the missing ones or rewrite this into your
  ...
  static void runSoldier() throws GameActionException {
    ...
    while (true) {
      ...
      try {
        ...
        // Clock.yield() makes the robot wait until the next turn, then it will
        // perform this loop again
        Clock.yield();
  ...
  static void runLumberjack() throws GameActionException {
    ...
    while (true) {
      ...
      // explode
      try {
        // See if there are any enemy robots within striking range (distance 1
        // from lumberjack's radius)
